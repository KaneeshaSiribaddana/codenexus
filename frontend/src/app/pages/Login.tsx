...
import logo from '../../images/islandClassroom_logo.png'

function Login() {
    return (
        <div>
            
            <section className="relative bg-[url(https://cdn.pixabay.com/photo/2017/06/29/18/37/sri-lanka-2455695_1280.jpg)] bg-cover bg-center bg-no-repeat">
                <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0 ">
                    <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0">
                        <div className="flex flex-col mt-2 items-center justify-center">
                            <a href="#" className="flex items-center text-2xl font-semibold text-gray-900 dark:text-white">
                                <Image className="w-48 h-16 mr-2" src={logo} alt="logo" />
                            </a>
                        </div>
